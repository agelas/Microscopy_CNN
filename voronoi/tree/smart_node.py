class SmartNode:
    ...
    def calculate_height(self):
        '''
        Recursively calculate the height of this node
    ...
    def update_heights(self):
        '''
        Recalculate the heights of this and all parent nodes
        '''
        self.update_height()
    ...
    def is_right_child(self):
        '''
        Determine whether this node is a right child
    ...
    def is_leaf(self):
        ...
        return: (bool) True if this node is a lead, False otherwise
        '''
        return self.left is None and self.right is None

    def minimum(self):
        '''
        Determines the node with the smallest key in the subtree rooted at this node
    ...
    def maximum(self):
        '''
        Determines the node with the largest key in the subtree rooted at this node
    ...
    def successor(self):
        ...
        '''
        #If the node has a right sub tree, return the minimum
        ...
        #Go to the right branch and take the minimum
    ...
    def predecessor(self):
        ...
        '''
        #If the node has a left subtree, take the maximum
        if self.left is not None:
            return self.left.maximum()
        
        #Walk up the right until no longer a left child
        current = self
    ...
    def replace_lead(self, replacement, root):
        ...
        #If node is a left child, replace it by giving the parent a new left node
        if self.is_left_child():
            self.parent.left = replacement
        #If node is a right child, replace it by giving the parent a new right node
        elif self.is_right_child():
            self.parent.right = replacement
        #Else just replace the root
        else:
            root = replacement
        ...
        #For empty replacement, strt updating heights from the parent
    ...
    def _visualize(self, depth = 0):
        '''
        Visualize the node and its descendents
        param depth: (int) Used by the formula to traverse down, should always start at 0

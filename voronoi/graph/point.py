...
class Point(Coordinate):
    ...
    def __init__(self, x=None, y=None, metadata=None, name=None, first_edge=None):
        ...
        param name: (str) A one-letter string assigned by algorithm
        param: first_edge: (HalfEdge) Pointer to the first edge assigned by algorithm
        '''
        super().__init__(x, y)
    ...
    def cell_size(self, digits=None):
        '''
        Calculates the cell size if the point is a site P_i.
    ...
    def get_coordinates(self):
        '''
        Find the coordinates of the cell's vertices.
        '''
        coordinates = []
    ...
    def _get_xy(self):
        '''
        Get the x and y coordinates of the edges of the cell P_i is in
        '''
